...
import { ShowAutoCADDrawingDialog } from './autocaddrawingdialog.js';
...
export class Website
{
    ...
    InitToolbar ()
    {
        ...
        AddButton (this.toolbar, 'details', Loc ('AutoCAD 2D Drawing & Auto-Dimension'), ['only_full_width', 'only_on_model'], () => {
            ShowAutoCADDrawingDialog (this.model, this.viewer);
        });
