...
export class ProgressDialog extends Dialog
{
    ...
    Init (text)
    {
        ...
        AddDiv (contentDiv, 'ov_progress_img', '<img src="assets/images/xdlinx_official_logo.png" alt="XDLINX SPACE LABS" style="height: 52px; object-fit: contain; margin-bottom: 12px; display: block; margin-left: auto; margin-right: auto; filter: drop-shadow(0 0 12px rgba(0,240,255,0.5));">');
